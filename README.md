...
* **样式与动画**：通过 CSS 完成页面布局、主题样式、响应式设计，以及窗口打开、淡入淡出等动画效果
* **交互逻辑**：使用原生 JavaScript 进行事件监听与 DOM 操作，实现各种互动功能，例如：
  * 单击 / 双击行为（如打开窗口、触发动画）
  * 窗口的缩放与关闭
  * 窗口的拖拽移动
  * 元素 hover 高亮、按钮反馈等 UI 效果
  * 状态管理与动态渲染：通过 JS 控制类名、CSS 动画触发、内容动态载入等方式构成简单的前端交互系统

<img width="1624" height="984" alt="image" src="https://github.com/user-attachments/assets/7b4ee376-dab3-4284-ab2e-86ab0765c076" />

## 效果展示
1. 从锁屏页面登录后进入桌面：

https://github.com/user-attachments/assets/3595c554-e7fa-4948-88f2-6fc1bec8fdd5

2. 双击图标可以点开窗口，窗口可拖拽，并且不会相互遮挡

https://github.com/user-attachments/assets/59e79b32-9aca-4e3b-aca8-e7f40eef5293

3. 点击左下角‘Start'图标可以’锁屏’
